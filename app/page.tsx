...
export default function Home() {
  ...
  return <div className="app-shell">
    ...
    <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
      ...
      <div className="logo"><div className="logo-mark"><Brain size={25} /></div><div><strong>YOSSEUF OS</strong><span>v1.4.0 · Platform & Mobile Foundation</span></div></div>
