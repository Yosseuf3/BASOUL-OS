...
export default function Home() {
  ...
  return <div className="app-shell">
    ...
    <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
      ...
      <div className="logo"><div className="logo-mark"><Brain size={25} /></div><div><strong>YOSSEUF OS</strong><span>v1.1.1 · Professional Project Wizard</span></div></div>
    ...
    {projectDetail && <ProjectWorkspace project={projectDetail} tasks={tasks.filter(t=>t.project_id===projectDetail.id)} financeItems={financeItems.filter(i=>i.project_id===projectDetail.id)} client={clients.find(c=>c.id===projectDetail.client_id)} onClose={()=>setProjectDetail(null)} onEdit={()=>{setProjectDetail(null);setProjectModal({mode:"edit",project:projectDetail});}} onCreateTask={()=>{setProjectDetail(null);setTaskModal({mode:"create",task:null});}} />}
