...
- تثبيت لوحة القيادة التنفيذية ومحركات الرؤية والأولوية والصحة.
- اعتماد مساحة المشروع المتكاملة للملفات والقرارات والمتابعات.
- فتح مساحة الهندسة للمخططات والمراجعات والذكاء المعماري.
- تثبيت تكامل Supabase وسياسات RLS وسجل النشاط والإشعارات.
- توحيد إصدار الويب والجوال وتجهيز قنوات النشر الرسمية.

# 3.0.0-rc.1 · Release Candidate

- رفع تجميد «مساحة الهندسة» وربطها مباشرة بالذكاء المعماري.
- اعتماد مساحة المشروع المتكاملة وDocument Control وسجل القرارات كمسارات مستقرة.
- بدء Feature Freeze قبل الإصدار الرسمي.
- رفع أرقام بناء iOS وAndroid وإعادة تشغيل بوابات الجودة الكاملة.

# 3.0.0-beta.3 · Integrated Project Workspace

- تفعيل سجل الملاحظات والقرارات والاجتماعات والمراجعات داخل كل مشروع.
- إضافة المسؤول وتاريخ المتابعة والحالة لكل سجل.
- ربط الملاحظة اختياريًا بملف من مركز ملفات المشروع.
- تحويل الملاحظة أو القرار إلى مهمة فعلية بضغطة واحدة.
- إضافة حالات مفتوح ومنفذ ومؤرشف، مع إعادة الفتح والحذف.
- تسجيل إنشاء الملاحظات وتحويلها إلى مهام في النشاط والإشعارات.
- إضافة جدول آمن وسياسات RLS وفهارس لسجل المشروع.
