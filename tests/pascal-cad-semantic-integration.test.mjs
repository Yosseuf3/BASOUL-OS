...
test('Pascal CAD v3.3 materializes native walls, hosted doors/windows and room slabs', () => {
...
test('3D Fidelity v3.3 derives opening width along the host wall and uses trustworthy CAD Z extents', () => {
...
test('3D Fidelity v3.1 preserves CAD door block orientation through Pascal and the visible leaf', () => {
  ...
  assert.match(viewer, /rotationY: nativeSwingReady \? -swing!\.openAngleRadians! : \(cadRotationY \?\? -Math\.atan2/)
})
