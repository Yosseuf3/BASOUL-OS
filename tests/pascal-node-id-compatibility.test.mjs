...
test('CAD Pascal materialization uses node ids compatible with Pascal beta.5 schemas', () => {
  ...
  assert.match(semantic, /wallIdFor = \(edgeId: string\) => pascalId\('wall_cad_pascal', edgeId\)/)
  assert.match(semantic, /openingIdFor = \(kind: 'door' \| 'window', entityId: string\) => pascalId\(`\$\{kind\}_cad_pascal`, entityId\)/)
