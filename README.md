...
![Version](https://img.shields.io/badge/version-v1.1.0-d4af37)
...
- [v1.1.0 hotfix release notes](RELEASE_NOTES_v1.1.0.md)
- [v1.0.0 release notes](RELEASE_NOTES_v1.0.0.md)
- [v1.1.0 hotfix test checklist](TEST_CHECKLIST_v1.1.0.md)
- [v1.0.0 test checklist](TEST_CHECKLIST_v1.0.0.md)

## Release status

**v1.1.0** is the authentication diagnostics hotfix built on the first official v1.0.0 Stable release. The stable branch should remain protected; new work should pass the Quality Gate and functional smoke tests before merging.
