...
![Version](https://img.shields.io/badge/version-v1.0.1-d4af37)
...
- [v1.0.1 hotfix release notes](RELEASE_NOTES_v1.0.1.md)
- [v1.0.0 release notes](RELEASE_NOTES_v1.0.0.md)
- [v1.0.1 hotfix test checklist](TEST_CHECKLIST_v1.0.1.md)
- [v1.0.0 test checklist](TEST_CHECKLIST_v1.0.0.md)

## Release status

**v1.0.1** is the authentication diagnostics hotfix built on the first official v1.0.0 Stable release. The stable branch should remain protected; new work should pass the Quality Gate and functional smoke tests before merging.
