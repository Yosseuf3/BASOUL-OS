...
const styles = StyleSheet.create({
  ...
  outline: { borderWidth: 1, borderColor: tokens.colors.border, borderRadius: tokens.radius.md, paddingHorizontal: 14, paddingVertical: 9 }, outlineText: { color: tokens.colors.gold, fontWeight: "800" },
  toolbar: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: tokens.space.md }, create: { backgroundColor: tokens.colors.gold, borderRadius: tokens.radius.md, paddingHorizontal: 15, paddingVertical: 11 }, createText: { color: tokens.colors.background, fontWeight: "900" }, summary: { color: tokens.colors.muted },
  filters: { flexDirection: "row-reverse", gap: 8, marginVertical: tokens.space.lg }, filter: { borderWidth: 1, borderColor: tokens.colors.border, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 8 }, filterActive: { backgroundColor: tokens.colors.gold, borderColor: tokens.colors.gold }, filterText: { color: tokens.colors.muted, fontWeight: "800" }, filterTextActive: { color: tokens.colors.background },
  empty: { color: tokens.colors.muted, textAlign: "center", marginTop: tokens.space.xl }, card: { backgroundColor: tokens.colors.surface, borderWidth: 1, borderColor: tokens.colors.border, borderRadius: tokens.radius.lg, padding: tokens.space.lg, marginBottom: tokens.space.md }, cardDanger: { borderColor: "#8d4444" },
  cardTop: { flexDirection: "row-reverse", justifyContent: "space-between" }, priority: { color: tokens.colors.gold, fontWeight: "900" }, critical: { color: "#ff8c8c" }, status: { color: tokens.colors.success, fontWeight: "800" }, name: { color: tokens.colors.text, fontSize: 20, fontWeight: "900", textAlign: "right", marginTop: 12 }, project: { color: tokens.colors.muted, textAlign: "right", marginTop: 5 },
  metaRow: { flexDirection: "row-reverse", justifyContent: "space-between", marginTop: 15 }, date: { color: tokens.colors.muted }, danger: { color: "#ff9898" }, progress: { color: tokens.colors.text, fontWeight: "800" }, track: { height: 7, backgroundColor: tokens.colors.background, borderRadius: 5, overflow: "hidden", marginTop: 9 }, fill: { height: "100%", backgroundColor: tokens.colors.gold }, advance: { alignSelf: "flex-end", marginTop: 14, borderWidth: 1, borderColor: tokens.colors.border, borderRadius: tokens.radius.sm, paddingHorizontal: 12, paddingVertical: 9 }, advanceText: { color: tokens.colors.gold, fontWeight: "800" },
});
