...
const styles = StyleSheet.create({
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: tokens.space.md }, back: { borderWidth: 1, borderColor: tokens.colors.border, borderRadius: tokens.radius.md, paddingHorizontal: 14, paddingVertical: 9 }, backText: { color: tokens.colors.gold, fontWeight: "800" }, kicker: { color: tokens.colors.gold, fontSize: 10, fontWeight: "900", textAlign: "right" }, title: { color: tokens.colors.text, fontSize: 31, fontWeight: "900", textAlign: "right" }, summary: { color: tokens.colors.muted, textAlign: "right", marginTop: 10, marginBottom: 24 }, row: { flexDirection: "row", alignItems: "stretch" }, rail: { width: 26, alignItems: "center" }, dot: { width: 11, height: 11, borderRadius: 6, backgroundColor: tokens.colors.gold, marginTop: 22 }, dotUrgent: { backgroundColor: "#ff8585" }, line: { width: 1, flex: 1, backgroundColor: tokens.colors.border, marginVertical: 5 }, card: { flex: 1, backgroundColor: tokens.colors.surface, borderWidth: 1, borderColor: tokens.colors.border, borderRadius: tokens.radius.md, padding: 16, marginBottom: 12 }, cardUrgent: { borderColor: "#824545" }, cardTop: { flexDirection: "row", justifyContent: "space-between" }, time: { color: tokens.colors.gold, fontWeight: "800", fontSize: 12 }, date: { color: tokens.colors.muted, fontSize: 12 }, itemTitle: { color: tokens.colors.text, fontSize: 17, fontWeight: "900", textAlign: "right", marginTop: 10 }, meta: { color: tokens.colors.muted, textAlign: "right", marginTop: 6, lineHeight: 19 }, emptyCard: { backgroundColor: tokens.colors.surface, borderWidth: 1, borderColor: tokens.colors.border, borderRadius: tokens.radius.lg, padding: 24 }, emptyTitle: { color: tokens.colors.text, textAlign: "right", fontWeight: "900", fontSize: 18 }, empty: { color: tokens.colors.muted, textAlign: "right", marginTop: 8 }
});
