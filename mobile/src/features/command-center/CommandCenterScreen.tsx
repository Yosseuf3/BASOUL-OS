  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View><Text style={styles.eyebrow}>YOSSEUF OS · EXECUTIVE KERNEL</Text><Text style={styles.title}>مركز القيادة</Text></View>
      </View>
...
const styles = StyleSheet.create({
  ...
  back: { color: tokens.colors.gold, fontWeight: "800" },
  eyebrow: { color: tokens.colors.gold, fontSize: 10, fontWeight: "800", textAlign: "right" },
  ...
  heroLabel: { color: tokens.colors.gold, textAlign: "right", fontWeight: "800" },
  ...
  confidence: { color: tokens.colors.gold, marginTop: 12, textAlign: "right", fontWeight: "700" },
  ...
  healthScore: { color: tokens.colors.gold, fontSize: 38, fontWeight: "900", textAlign: "right" },
  ...
  factorScore: { color: tokens.colors.gold, fontWeight: "900" },
  ...
  badge: { color: tokens.colors.gold, fontWeight: "900" },
