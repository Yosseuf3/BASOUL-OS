  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View><Text style={styles.eyebrow}>YOSSEUF OS Â· EXECUTIVE KERNEL</Text><Text style={styles.title}>Ù…Ø±ÙƒØ² Ø§Ù„Ù‚ÙŠØ§Ø¯Ø©</Text></View>
      </View>

      <View style={styles.hero}>
        <Text style={styles.heroLabel}>Ù…Ø§Ø°Ø§ ÙŠØ¬Ø¨ Ø£Ù† ØªÙØ¹Ù„ Ø§Ù„Ø¢Ù†ØŸ</Text>
      ...
      <Text style={styles.sectionTitle}>Ø§Ù„Ù‚Ø±Ø§Ø±Ø§Øª Ø§Ù„ØªÙ†ÙÙŠØ°ÙŠØ©</Text>
      ...
      {snapshot.risks.map((risk) => (
        <View key={risk.id} style={styles.card}>
          ...
          <Text style={styles.action}>Ø§Ù„ØªØ®ÙÙŠÙ: {risk.mitigation}</Text>
        </View>
      ))}
    </ScrollView>
  );
