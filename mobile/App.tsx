...
export default function App() {
  ...
  return <View style={styles.app}>
    ...
    <View style={styles.footer}><Text style={styles.version}>v3.0.0-beta.1 · Production Readiness</Text><TouchableOpacity onPress={() => void supabase?.auth.signOut()}><Text style={styles.logout}>تسجيل الخروج</Text></TouchableOpacity></View>
  </View>;
}
